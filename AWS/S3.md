...
### 3. 객체(Object)
  ...
  - 객체를 새로 추가하면 바로 읽을 수 있지만, 객체를 업데이트하거나 삭제하면 propagate하는데에 시간이 걸린다.
...
- S3 Standard
  - 99.99% availability, 99.999999999% durablity.
  - 다수의 장치와 다수의 시설에 저장
...
- 내구성이 다른 두 가지 옵션이 있다. 
  - Standard Storage는 중요한 데이터 저장.(내구성 99.999999999%), 2개의 시설을 동시에 잃어도 지속된다.
  - 파일을 올리고 나서도 설정할 수 있다.
